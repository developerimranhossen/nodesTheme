...
function PricingCard() {
  return (
    <div className="flex flex-col items-center gap-10 w-[384px] py-10 px-8 border-[1.5px] border-background-stroke-surface rounded-2xl bg-background-fill-white">
        ...
        <hr className="w-[320px] h-[1px] border-0 bg-[#E0D2E7]" />
...
<p className="text-container-text-gray leading-[20.8px]">20GB Storage capacity</p>
        ...
        <CustomButton className={'w-full bg-container-fill-light border-container-stroke-secondary text-container-text-secondary'} >Start Build today</CustomButton>
    </div>
  )
}
